...
# 激活真实运行环境
source /mnt/afs/share_data/huangting3/envs/internvl.sh
...
CONFIG=/mnt/afs/huangting3/workspace/InternEvo/configs/deepseek3_hf.py

cd $ROOT
export PYTHONPATH=$ROOT:$PYTHONPATH
export ENV_PATH=${ENV_PATH:-"/mnt/afs/share_data/huangting3/envs/internvl_torch2.5.1"}
