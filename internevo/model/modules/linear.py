...
from internevo.model.ops.linear import (
    gmm_backward_op,
    gmm_forward_op,
    linear_backward_op,
    linear_forward_op,
...
if TYPE_CHECKING:
    from internevo.core.parallel.comm.isp import WPCommunicator
    from internevo.core.parallel.comm.tensor import TPCommunicator
    ...
    def backward(ctx, grad_output, *args):
        ...
        if ctx.needs_input_grad[1]:
            ...
            if gpc.is_using_parallel_mode(ParallelMode.PIPELINE) and (
                ...
                from internevo.core.scheduler.pipeline_scheduler_zb import (
                    WeightGradStore,
                )
