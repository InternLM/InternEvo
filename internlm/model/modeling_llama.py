    ...
    def _forward(self, x, seqlen=None, inference_params=None, **kwargs):  # pylint: disable=W0613
        ...
        if inference_params is None:
            ...
            if hasattr(inference_params, "attention_mask") and inference_params.attention_mask is not None:
                ...
                q = self.rotary_emb._single_eval_forward(q, seqlen_offset=inference_params.sequence_len_offset)
                k = self.rotary_emb._single_eval_forward(k, seqlen_offset=inference_params.sequence_len_offset)
