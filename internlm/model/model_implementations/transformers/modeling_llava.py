...
from internlm.model.model_implementations.transformers.modeling_llama import (
    Llama2Decoder,
)
from internlm.model.model_implementations.transformers.utils import normal_, uniform_
from internlm.model.model_ops.llava.clip_builder import build_vision_tower
from internlm.model.model_ops.llava.projector_builder import build_vision_projector
...
class Llava(BaseTransformerModel):
    """
