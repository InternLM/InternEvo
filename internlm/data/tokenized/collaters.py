...
def nopack_collate_fn(batch, packed_length, eos_token, gen_attn_mask):
    ...
    # print(f"input_ids: {xs.shape}, S cu_seqlens: {cu_seqlens.shape}, type_ids: {ts.shape}", flush=True)
